;(function($, doc, nokia){
    ...
    */
    ...
    //
    //**miniHERE** is a jQuery plugin that makes it easy to add maps to websites and programmatically
    //change the zoom level of the map. It has a zoom bar and supports drag and mouse wheel for pan and zoom.
    //
    //### How to instantiate the plugin
    //
    //<pre><code>$('selector').miniHERE({
    //    zoom: &lt;NUMBER&gt;,
    //    center: &lt;Array|Object&gt;,
    //    appId: &lt;String&gt;,
    //    authToken: &lt;String&gt;
    ...
    */
    ...
    //### How to change the map's zoom level
    //
    //<pre><code>$('selector').miniHERE('zoom', &lt;NUMBER&gt;);</code></pre>

    H.zoom = function(newZoomLevel){
        this.map.set('zoomLevel', newZoomLevel);
    };

    //### How to extend miniHERE
    //
    //It is possible to extend miniHERE to add additional functionalities.
    //
    //<pre><code>$.miniHERE.extend('foo', &lt;FUNCTION&gt;);</code></pre>
